...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getAllUsers: function getAllUsers() {
      ...
      _services_api__WEBPACK_IMPORTED_MODULE_2__["default"].getAllUsers().then(function (response) {
    ...
    deleteUser: function deleteUser(id) {
      ...
      _services_api__WEBPACK_IMPORTED_MODULE_2__["default"].deleteUser(id).then(function () {
        _this2.getAllUsers();
      });
    },
    ...
    changeUsersRoleToAdmin: function changeUsersRoleToAdmin(id) {
      ...
      _services_api__WEBPACK_IMPORTED_MODULE_2__["default"].changeUserAdminStatus(id).then(function () {
        _this3.getAllUsers();
      });
    }
  },
