                  ...
                  _c(
                    ...
                    [
                      ...
                      _c("v-card-text", [
                        ...
                        _vm._v(" "),
                        _c("p", [
                          _vm._v("Naslov: " + _vm._s(order.User[0].Region)),
                          _c("br"),
                          _vm._v(
                            " " +
                              _vm._s(order.User[0].houseNumberAndStreet) +
                              " "
                          ),
                          _c("br"),
                          _vm._v(_vm._s(order.User[0].Postcode))
                        ])
                      ]),
                      _vm._v(" "),
                      ...
                      !order.DeliveryStatus
                        ...
                        : _c("v-card-text", [
                            _c("p", [_vm._v("Naročilo je bilo potrjeno.")])
                          ])
                    ],
                    1
                  )
