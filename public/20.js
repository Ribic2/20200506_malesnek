...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    changeBasicInfo: function changeBasicInfo() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_3___default.a.post('/api/user/change/basic', credentials).then(function (results) {
    ...
    changeResidenceInfo: function changeResidenceInfo() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_3___default.a.post('/api/user/change/residence', credentials).then(function (results) {
